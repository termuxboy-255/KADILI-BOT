...
const traduire = require("../kadili/traduction");
...
adams({
  ...
  try {
    const axios = require('axios');
    const response = await axios.get(`https://kadili-session.onrender.com/emix?q=${emoji1}${emoji2}`);
